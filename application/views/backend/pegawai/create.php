                            ...
                            <form action="<?= base_url('pegawai/create'); ?>" method="POST">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="gender" placeholder="LAKI - LAKI / PEREMPUAN">
                                    </div>
                                    <div class="form-group">
                                        <label for="nip">NIP (Nomer Induk Pegawai)</label>
                                        <input type="text" class="form-control" name="nip" placeholder="19xx.200x.0x.00x">
                                    </div>
                                    <div class="form-group">
                                        <label for="ttl">TTL (Tempat Tanggal Lahir)</label>
                                        <input type="text" class="form-control" name="ttl" placeholder="City, dd/mm/yyyy">
                                    </div>
                                    <div class="form-group">
                                        <label for="tmk">TMK (Tanggal Masuk Kerja)</label>
                                        <input type="text" class="form-control" name="tmk" placeholder="Month Year">
                                    </div>
                                    <div class="form-group">
                                        <label>Status</label>
                                        <input type="text" class="form-control" name="status" placeholder="PEGAWAI TETAP / TIDAK TETAP">
                                    </div>
                                    <div class="form-group">
                                        <label>Pendidikan</label>
                                        <input type="text" class="form-control" name="pendidikan" placeholder="S1/D4/D3/SMA">
                                    </div>
                                    <div class="form-group">
                                        <label>Golongan</label>
                                        <input type="text" class="form-control" name="golongan" placeholder="1/2/3">
                                    </div>
                                </div>
                                <!-- /.card-body -->
